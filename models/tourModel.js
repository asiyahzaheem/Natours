...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      maxlength: [
        '40',
        'A tour must have a name less than or equal to 40 characters',
      ],
      minlength: [
        '10',
        'A tour must have a name greater than or equal to 10 characters',
      ],
    ...
    priceDiscount: {
      type: Number,
      validate: {
        // works only only NEW doc created
...
// doc middleware: runs one only .save() and .create()
